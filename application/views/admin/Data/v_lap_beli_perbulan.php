...
?>
  ...
  <section class="content">
      ...
      <?php if($h=='1'|| $h=='2'){ ?>
              ...
              <p>Data tersebut diambil berdasarkan bulan yang dipilih</p>
              </div>
		  <?php }?>
                  ...
                  <?php if($h =='1' || $h == '2') {?>
                     ...
                     <a href="<?php echo base_url().'admin/transaksi/data_pembelian'?>" class="btn btn-sm btn-danger" ><span class="fa fa-back"></span> Kembali</a>
...
<!-- ./wrapper -->
 ...
 <div class="modal fade" id="lap_jual_perbulan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/laporan/lap_pembelian_perbulan'?>" target="_blank">
