  ...
  <section class="content">
	...
	?>
                <div class="alert alert-success">
                    <strong>Transaksi Berhasil Silahkan Cetak Faktur Transaksi <?php echo $nofak; ?> !</strong>
                    <a class="btn btn-default" href="<?php echo base_url().'admin/transaksi'?>"><span class="fa fa-backward"></span>Kembali</a>
                    <a class="btn btn-info" href="cetak_faktur_bayar/<?php echo $nofak; ?>" target="_blank"><span class="fa fa-print"></span>Cetak</a>
                    <?php endforeach;?>
                </div>
            </div>
        </div>
