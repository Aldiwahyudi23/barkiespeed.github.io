...
$b = $data->row_array();
?>
        <form action="<?php echo base_url() . 'admin_web/potensi/update_potensi' ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-md-10">
                ...
                <input type="text" name="xjudul" class="form-control" value="<?php echo $b['judul']; ?>" placeholder="Judul potensi atau artikel" required/>
              </div>
              <!-- /.col -->
              <div class="col-md-2">
