...
foreach ($data->result() as $row): ?>
                <tr>
                  ...
                  <td><a href="<?php echo site_url('artikel/detail/' . $row->slug); ?>" target="_blank"><?php echo $row->judul; ?></a></td>
                  <td><?php echo date("d M Y H:i", strtotime($row->tanggal)); ?></td>
                  <td style="text-align:right;">
                    <?php if ($row->status == '1' && $row->parent == '0'): ?>
                      <a class="btn btn-reply" href="javascript:void(0);" data-id="<?php echo $row->id; ?>" data-post_id="<?php echo $row->artikelid; ?>" title="Balas"><span class="fa fa-reply"></span></a>
                      <a class="btn btn-hapus" href="javascript:void(0);" data-id="<?php echo $row->id; ?>" title="Hapus"><span class="fa fa-trash"></span></a>
                    <?php elseif ($row->status == '1'): ?>
                      <a class="btn btn-hapus" href="javascript:void(0);" data-id="<?php echo $row->id; ?>" title="Hapus"><span class="fa fa-trash"></span></a>
                    <?php else: ?>
                      <a class="btn" href="<?php echo site_url('admin_web/komentar/publish/' . $row->id); ?>" title="Publish"><span class="fa fa-send"></span></a>
                      <a class="btn btn-hapus" href="javascript:void(0);" data-id="<?php echo $row->id; ?>" title="Hapus"><span class="fa fa-trash"></span></a>
                    <?php endif;?>
                  </td>
                </tr>
