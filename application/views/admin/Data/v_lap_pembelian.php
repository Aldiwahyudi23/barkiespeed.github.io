...
?>
  ...
  <section class="content">
      ...
      <?php if($h=='1'|| $h=='2'){ ?>
              ...
              <h4><i class="fa fa-warning"></i> Perhatian!</h4> Perhatikan Data Hasil Transaksi.
              <p>Data ini hasil dari transaksi pembelian barang dari pengirim</p>
              </div>
		  <?php }?>
...
<?php if ($this->session->flashdata('msg') == 'error'): ?>
    ...
    <script type="text/javascript">
	 ...
	 <div class="modal fade" id="lap_jual_pertanggal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/transaksi/pembelian_pertanggal'?>">
        ...
        <div class="modal fade" id="lap_jual_perbulan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/transaksi/pembelian_perbulan'?>">
                <div class="modal-body">
        ...
        <div class="modal fade" id="lap_jual_pertahun" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/transaksi/pembelian_pertahun'?>">
                <div class="modal-body">
