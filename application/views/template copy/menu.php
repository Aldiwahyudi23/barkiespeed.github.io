...
<header>
  ...
  <nav class="navbar navbar-expand-xl navbar-dark fixed-top bg-primary">
    ...
    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
      <a <?php echo (($this->uri->segment(1) == "alurpelayanan") ? 'class="dropdown-item active"' : 'class="dropdown-item "') ?> href="<?php echo base_url() . '#'; ?>">Alur Kegiatan Pelayanan</a>
      <a <?php echo (($this->uri->segment(1) == "denahpelayanan") ? 'class="dropdown-item active"' : 'class="dropdown-item "') ?> href="<?php echo base_url() . '#'; ?>">Denah Jalur Pelayanan</a>
      <a <?php echo (($this->uri->segment(1) == "jenispelayanan") ? 'class="dropdown-item active"' : 'class="dropdown-item "') ?> href="<?php echo base_url() . '#'; ?>">Jenis Pelayanan</a>
