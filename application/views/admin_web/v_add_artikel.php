   ...
   <div class="masuk-bg content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <form action="<?php echo base_url() . 'admin_web/artikel/simpan_artikel' ?>" method="post" enctype="multipart/form-data">

          <!-- /.box-header -->
          <div class="box-body">
            <div class="row">
              <div class="col-md-10">
                <input type="text" name="xjudul" class="form-control" placeholder="Judul artikel atau artikel" required/>
              </div>
              <!-- /.col -->
              <div class="col-md-2">
...
foreach ($kat->result_array() as $i):
	...
	?>
	                   <option value="<?php echo $kategoriid; ?>"><?php echo $kategorinama; ?></option>
	                 <?php endforeach;?>
               </select>
             </div>
