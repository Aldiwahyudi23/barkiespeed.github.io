<div id="footer" class="footer">
	<div class="container">
		...
		Copyright &copy;  <?php echo date("Y") ?> Barkiespeed | Made with <span i class="fa fa-heart" style="color:#DC3545"> </span> by <a href="https://wa.083825740395" target="_blank">Aldi Wahyudi</a>
	</div>
</div>
</main>
<?php $i = $ig->row_array()?>
