<style>
		.masuk-bg {
			background-image: url(http://localhost/barkiespeed/assetss/images/background.jpg);
		}
		</style>
<!--Counter Inbox-->
<body class="hold-transition skin-red sidebar-mini fixed skin-dark-light masuk-bg">
  	<div class="wrapper">
<?php
...
?>
       <li class="dropdown user user-menu">
        ...
        <?php if($h=='1'|| $h=='2'){ ?>
        <li>
          <a href="<?php echo base_url() . 'admin_web/dashboard' ?>" title="Admin Website"><i class="fa fa-book"></i></a>
        </li>
        <?php } ?>
      </ul>
    </div>
