  		...
  		<div class="col-xs-12">
  			<div class="box">
  				...
  				<div class="box">
                      ...
                      <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#largeModal"><span class="fa fa-plus"></span> Tambah Suplier</a>
  					</div>
  					<!-- /.box-header -->
...
<!-- ./wrapper -->
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel">Tambah Data Suplier</h3>
            </div>
        ...
        <?php
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Perusahaan</label>
                        <div class="col-xs-9">
                            <input name="perusahaan" class="form-control" type="text" placeholder="perusahaan..." value="<?php echo $perusahaan;?>" required>
                        </div>
                    </div>
	...
	<?php elseif ($this->session->flashdata('msg') == 'success'): ?>
		...
		<?php elseif ($this->session->flashdata('msg') == 'info'): ?>
			<script type="text/javascript">
				$.toast({
					heading: 'Info',
					text: "supplier berhasil di update",
					showHideTransition: 'slide',
					icon: 'info',
					hideAfter: false,
					position: 'bottom-right',
