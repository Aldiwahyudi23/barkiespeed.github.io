            ...
            <div class="box">
              ...
              <div class="box">
                <div class="box-header">
                  <a class="btn btn-success btn-flat" href="<?php echo base_url() . 'admin_web/artikel/add_artikel' ?>"><span class="fa fa-plus"></span> Tambah artikel</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
	...
	?>
	                     <tr>
	                      ...
	                      <td style="text-align:right;">
	                        <a class="btn btn-primary btn-xs" href="<?php echo base_url() . 'admin_web/artikel/get_edit/' . $id; ?>"><span class="fa fa-pencil"></span></a>
	  ...
	  <div class="modal fade" id="ModalHapus<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	    <div class="modal-dialog" role="document">
	      <div class="modal-content">
	        ...
	        <form class="form-horizontal" action="<?php echo base_url() . 'admin_web/artikel/hapus_artikel' ?>" method="post" enctype="multipart/form-data">
